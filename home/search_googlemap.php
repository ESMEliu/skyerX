...
<head>
    ...
    <title><?=lang('Search map')?> | skyerX</title>
    <meta charset="utf-8">
    ...
    <div class="row">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="widget">
                <div class="row">
                    <ul class="smap-btns">
                        <a class="col-xs-4 active" href="<?=site_url('home/search_googlemap')?>"><li><?=lang('地圖')?></li></a>
                        <a class="col-xs-4 " href="<?=site_url('home/search_map')?>"><li><?=lang('作品清單')?></li></a>
                    </ul>
                </div>
            </div>
            ...
            <div class="swiper-container swiper-mission">
                <div class="swiper-wrapper searchmap">
...
<script id="temp" type="text/html">
    ...
    <div class="swiper-slide">
        <div class="ui-block video-item">
            <a href="###" onclick="star2({{id}})" id="star_2_{{id}}">
                <span class="collect <% if(star){ %>add<% } %>"><i class="fa fa-star<% if(!star){ %>-o<% } %>" aria-hidden="true"></i></span>
            </a>
            <div class="video-player" onclick="location.href='<?= site_url('home/detail')?>/{{id}}'">
                <img src="{{media_url}}" alt="photo" />
                <a href="<?=site_url('home/detail')?>/{{id}}" class="play-video">
                    <img src="/asset/img/play-btn.png" alt="" />
                </a>
                <div class="ui-block-content video-content">
                    <a href="<?=site_url('home/detail')?>/{{id}}" class="h6 title na">{{title}}</a>
                    <a href="###" class="h6 title so" id="like_2_{{id}}" onclick="like2({{id}});">
                        <i class="fa fa-heart<% if(!like){ %>-o<% } %> " aria-hidden="true"></i><span id="like_count_{{id}}">{{like_count}}</span>
                    </a>
                </div>
            </div>
        </div>
    ...
    <div class="swiper-slide">
        <article class="hentry blog-post blog-post-v1">
            <div class="post-thumb"  onclick="location.href='<?=site_url('home/detail')?>/{{id}}'">
                <a href="###" onclick="star2({{id}})" id="star_2_{{id}}">
                    <span class="collect <% if(star){ %>add<% } %>"><i class="fa fa-star<% if(!star){ %>-o<% } %>" aria-hidden="true"></i></span>
                </a>
                <a class="" href="<?=site_url('home/detail')?>/{{id}}" title="" target="_blank">
                    <img src="{{media_url}}" />
                </a>
                <div class="post-content">
                    <a href="<?=site_url('home/detail')?>/{{id}}" class="h6 post-title">{{title}}</a>
                    <a href="###" class="h6 post-icon" id="like_2_{{id}}" onclick="like2({{id}});">
                        <i class="fa fa-heart<% if(!like){ %>-o<% } %> " aria-hidden="true"></i><span id="like_count_{{id}}">{{like_count}}</span>
                    </a>
                </div>
            </div>
