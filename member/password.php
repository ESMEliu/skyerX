...
<div class="container edit-widget-twitter">
    ...
    <div class="row">
        ...
        <div class=" col-sm-9 col-xs-9">
            <div class="ui-block">
                <div class="ui-block-title">
                    <h6 class="title"><?=lang('更改密碼')?></h6>
                </div>
                <div class="ui-block-content col-sm-12">
                    <form class="member-manage" action="<?=site_url('member/password_do')?>" method="post">
                        <div class="form-group row">
                            <label class="col-lg-2 col-sm-4 col-form-label"><?=lang('舊密碼')?></label>
                            <div class=" col-lg-8 col-sm-8">
                                <input type="password" name="password" class="form-control-plaintext" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-lg-2 col-sm-4 col-form-label"><?=lang('新密碼')?></label>
                            <div class=" col-lg-8 col-sm-8">
                                <input type="password" name="new_password" class="form-control-plaintext" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-lg-2 col-sm-4 col-form-label"><?=lang('確認新密碼')?></label>
                            <div class=" col-lg-8 col-sm-8">
                                <input type="password" name="new_password2" class="form-control-plaintext" required>
                            </div>
                        </div>
                        <div class="row mt">
